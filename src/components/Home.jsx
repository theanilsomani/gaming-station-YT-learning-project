        ...
        <Container maxW={'container.xl'} minH={'100vh'} p={'16'}>
            ...
            <Stack h={'full'} p={'4'} alignItems={'center'} direction={['column', 'row']}>
                ...
                <Text letterSpacing={'widest'} lineHeight={'190%'} p={['4', '16']} textAlign={'center'}>
                    ...
                    Doloribus eligendi mollitia dolores quidem labore dolore eaque fugiat,
                    tempore accusantium veritatis in officia ut.
                    Corrupti neque vero assumenda iusto ab fuga.
                    Lorem ipsum dolor sit amet consectetur adipisicing elit.
                    Doloribus eligendi mollitia dolores quidem labore dolore eaque fugiat,
                    tempore accusantium veritatis in officia ut.
                    Corrupti neque vero assumenda iusto ab fuga.
...
const MyCarousel = ()=>(
    <Carousel autoPlay infiniteLoop interval={1000} showStatus={false} showThumbs={false} showIndicators={false}>
        ...
        <Box w='full' h={'100vh'}>
            ...
            <Heading bg={'whiteAlpha.600'} color={'black'} {...headingOptions}>Night Gaming Litt</Heading>
        </Box>
